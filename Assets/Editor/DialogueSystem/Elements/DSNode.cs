...
public class DSNode : Node {
	...
	public virtual void Draw() {
		...
		ObjectField objectField = DSElementUtility.CreateObjectField(Character, "Character Data", callback => Character = (CharacterData)callback.newValue);
	...
	public bool IsStartingNode() {
		if (this is DSRootNode) return true;
		
		if (inputContainer == null || inputContainer.childCount == 0) return true;
